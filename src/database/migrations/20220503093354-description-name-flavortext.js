...
const { GrowthrateProseSchema, GROWTHRATE_PROSE_TABLE } = require("../models/growthrate-description.model");
const { HabitatNameSchema, HABITAT_NAME_TABLE } = require("../models/habitat-name.model");
const { ItemAttributeDescriptionSchema, ITEM_ATTRIBUTE_DESCRIPTION_TABLE } = require("../models/item-attribute-description.model");
const { ItemAttributeNameSchema, ITEM_ATTRIBUTE_NAME_TABLE } = require("../models/item-attribute-name.model");
...
const { MoveAttributeDescriptionSchema, MOVE_ATTRIBUTE_DESCRIPTION_TABLE } = require("../models/move-attribute-description.model");
const { MoveAttributeNameSchema, MOVE_ATTRIBUTE_NAME_TABLE } = require("../models/move-attribute-name.model");
const { MoveBattlestyleNameSchema, MOVE_BATTLESTYLE_NAME_TABLE } = require("../models/move-battlestyle-name.model");
const { MoveDamageClassDescriptionSchema, MOVE_DAMAGE_CLASS_DESCRIPTION_TABLE } = require("../models/move-damage-class-description.model");
const { MoveDamageClassNameSchema, MOVE_DAMAGE_CLASS_NAME_TABLE } = require("../models/move-damage-class-name.model");
const { MoveLearnMethodDescriptionSchema, MOVE_LEARN_METHOD_DESCRIPTION_TABLE } = require("../models/move-learn-method-description.model");
const { MoveLearnMethodNameSchema, MOVE_LEARN_METHOD_NAME_TABLE } = require("../models/move-learn-method-name.model");
const { MoveMetaAilmentNameSchema, MOVE_META_AILMENT_NAME_TABLE } = require("../models/move-meta-ailment-name.model");
const { MoveTargetDescriptionSchema, MOVE_TARGET_DESCRIPTION_TABLE } = require("../models/move-target-description.model");
const { MoveTargetNameSchema, MOVE_TARGET_NAME_TABLE } = require("../models/move-target-name.model");
...
const { ShapeNameSchema, SHAPE_NAME_TABLE } = require("../models/shape-name.model");
...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.createTable(ITEM_ATTRIBUTE_DESCRIPTION_TABLE, ItemAttributeDescriptionSchema);
    await queryInterface.createTable(MOVE_ATTRIBUTE_DESCRIPTION_TABLE, MoveAttributeDescriptionSchema);
    await queryInterface.createTable(MOVE_DAMAGE_CLASS_DESCRIPTION_TABLE, MoveDamageClassDescriptionSchema);
    await queryInterface.createTable(MOVE_LEARN_METHOD_DESCRIPTION_TABLE, MoveLearnMethodDescriptionSchema);
    await queryInterface.createTable(MOVE_TARGET_DESCRIPTION_TABLE, MoveTargetDescriptionSchema);
    ...
    await queryInterface.createTable(ITEM_ATTRIBUTE_NAME_TABLE, ItemAttributeNameSchema);
    ...
    await queryInterface.createTable(MOVE_ATTRIBUTE_NAME_TABLE, MoveAttributeNameSchema);
    await queryInterface.createTable(MOVE_BATTLESTYLE_NAME_TABLE, MoveBattlestyleNameSchema);
    await queryInterface.createTable(MOVE_DAMAGE_CLASS_NAME_TABLE, MoveDamageClassNameSchema);
    await queryInterface.createTable(MOVE_LEARN_METHOD_NAME_TABLE, MoveLearnMethodNameSchema);
    await queryInterface.createTable(MOVE_META_AILMENT_NAME_TABLE, MoveMetaAilmentNameSchema);
    await queryInterface.createTable(MOVE_TARGET_NAME_TABLE, MoveTargetNameSchema);
    ...
    await queryInterface.createTable(SHAPE_NAME_TABLE, ShapeNameSchema);
  ...
  async down (queryInterface, Sequelize) {
    ...
    await queryInterface.dropTable(ITEM_ATTRIBUTE_DESCRIPTION_TABLE);
    await queryInterface.dropTable(MOVE_ATTRIBUTE_DESCRIPTION_TABLE);
    await queryInterface.dropTable(MOVE_DAMAGE_CLASS_DESCRIPTION_TABLE);
    await queryInterface.dropTable(MOVE_LEARN_METHOD_DESCRIPTION_TABLE);
    await queryInterface.dropTable(MOVE_TARGET_DESCRIPTION_TABLE);
    ...
    await queryInterface.dropTable(ITEM_ATTRIBUTE_NAME_TABLE);
    await queryInterface.dropTable(ITEM_POCKET_NAME_TABLE);
    await queryInterface.dropTable(LANGUAGE_NAME_TABLE);
    await queryInterface.dropTable(MOVE_ATTRIBUTE_NAME_TABLE);
    await queryInterface.dropTable(MOVE_BATTLESTYLE_NAME_TABLE);
    await queryInterface.dropTable(MOVE_DAMAGE_CLASS_NAME_TABLE);
    await queryInterface.dropTable(MOVE_LEARN_METHOD_NAME_TABLE);
    await queryInterface.dropTable(MOVE_META_AILMENT_NAME_TABLE);
    await queryInterface.dropTable(MOVE_TARGET_NAME_TABLE);
    ...
    await queryInterface.dropTable(SHAPE_NAME_TABLE);
